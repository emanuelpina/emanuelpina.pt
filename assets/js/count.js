    ...
    !(function (t) {
        ...
        if (d) {
            var m = "data-",
                ...
                x = function () {
                    return { website: h, hostname: s, screen: w, language: a, title: I, url: q, referrer: C };
                },
                E = function () {
                    return (
                ...
                D = function (t) {
                    if (!E()) {
                        ...
                        return (
                            ...
                            fetch(k, { method: "POST", body: JSON.stringify({ type: "event", payload: t }), headers: e })
                                .then(function (t) {
                                    return t.text();
                                })
                                .then(function (t) {
                ...
                K = function (t, e) {
                    return D("string" == typeof t ? Object.assign({}, x(), { name: t, data: "object" == typeof e ? e : void 0 }) : "object" == typeof t ? t : "function" == typeof t ? t(x()) : x());
                };
            ...
            if (g && !E()) {
                (c.pushState = A(c, "pushState", O)),
                    ...
                    new MutationObserver(function (t) {
                        var e = t[0];
                        I = e && e.target ? e.target.text : void 0;
                    }).observe(u.querySelector("head > title"), { subtree: !0, characterData: !0, childList: !0 });
                var J = function () {
                    "complete" !== u.readyState || P || (K(), (P = !0));
                };
                u.addEventListener("readystatechange", J, !0), J();
            }
        }
    })(window);
})();
