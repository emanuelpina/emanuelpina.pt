        ...
        if (d) {
            var v,
                ...
                _ = function (t, e) {
                    var n;
                    if (!m())
                        return fetch(j, { method: "POST", body: JSON.stringify({ type: t, payload: e }), headers: p({ "Content-Type": "application/json" }, ((n = {}), (n["x-umami-cache"] = v), n)) })
                            .then(function (t) {
                                return t.text();
                            })
                            .then(function (t) {
                ...
                q = function (t, e, n) {
                    return void 0 === t && (t = D), void 0 === e && (e = P), void 0 === n && (n = w), _("pageview", p($(), { website: n, url: t, referrer: e }));
                },
                z = function (t, e, n, r) {
                    return void 0 === n && (n = D), void 0 === r && (r = w), _("event", p($(), { website: r, url: n, event_name: t, event_data: e }));
                },
                C = function (t) {
                        ...
                        if (O.test(n)) {
                            var r = n.split("--"),
                                ...
                                c = L[n]
                                    ? L[n]
                                    : (L[n] = function (n) {
                                          "click" !== a || "A" !== t.tagName || n.ctrlKey || n.shiftKey || n.metaKey || (n.button && 1 === n.button) || e("target")
                                              ? z(o)
                                              : (n.preventDefault(),
                                                z(o).then(function () {
                                                    var t = e("href");
